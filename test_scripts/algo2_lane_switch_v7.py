#!/usr/bin/env python3
"""algo2_lane_switch — 世界体素 v7

v6→v7: find_frontier 加 wall_distance 评分——在直线可达体素中挑离墙最远的
数据: 1m³体素 0=未知 1=通畅 2=墙 3=已走
决策: 扫清四周→找直线可达体素→朝wp+离墙远+未知邻居多
"""
...
print(f"=== algo2 体素 v7 (wall-distance scoring) === {VOXEL}m³ Mover", flush=True)
